...
export default function HistorialAlimentacionScreen({ navigation }) {
  ...
  if (error)   return <Text tamano="sm" color={COLORS.error} alineacion="center">{error}</Text>;

  return (
    <View style={styles.screen}>
      <ScrollView contentContainerStyle={styles.contenido}>
        <Text tamano="xs" color={COLORS.tertiaryTxt} fuente={TYPOGRAPHY.fontFamily.regular} estilo={styles.total}>
      ...
      >
        ...
        <Text tamano="sm" color={COLORS.primary} fuente={TYPOGRAPHY.fontFamily.regular}>VOLVER</Text>
      </Pressable>
    </View>
  );
}
