...
export default function FormularioConteo() {
  const {
    numeroCamarones,tirosAtarraya,areaAtarraya,promedioPorTiro, sobrevivencia, notasConteo,
        setNumeroCamarones, setTirosAtarraya,setAreaAtarraya,setPromedioPorTiro,setSobrevivencia,setNotasConteo,
      } = useDatosConteo();
  ...
  return (
    <>
      ...
      <Input
        placeholder="Número de camarones contados"
