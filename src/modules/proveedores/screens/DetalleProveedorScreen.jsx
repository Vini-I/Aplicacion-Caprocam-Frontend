 ...
 * Permite navegar a la edición o eliminar el proveedor mediante un modal de confirmación.
 */
...
// Busca un proveedor en el mock por su id numérico
function getProveedorMockById(id) {
...
export default function DetalleProveedorScreen() {
  ...
  const proveedor = getProveedorMockById(id);
  ...
  return (
    <View style={styles.contenedor}>
        ...
        <Card style={styles.tarjeta}>
          ...
          <View style={styles.header}>
            ...
            <View style={styles.proveedorInfo}>
              ...
              <Badge
                label={getTipoProductoSelect(proveedor.tipoProducto)}
                style={styles.badge}
          ...
          {/* Sección de notas, solo se muestra si el proveedor tiene notas */}
          {!!proveedor.notas && (
      ...
      {/* Modal de confirmación antes de eliminar el proveedor */}
      <Modal
