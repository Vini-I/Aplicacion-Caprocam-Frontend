/**
 * ============================================================
 * COMPONENTE MODAL SESIÓN CERRADA
 * ============================================================
 *
 * Modal reutilizable para notificar que la sesión ha sido cerrada.
 *
 * Funcionalidad:
  ...
  return (
    ...
    >
      ...
      <Button style={styles.confirmButton} onPress={onConfirm}>
        <Text style={styles.confirmButtonText}>{"Si, cerrar sesión"}</Text>
      </Button>
    </Modal>
  );
}
